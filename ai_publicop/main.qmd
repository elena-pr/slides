...
::: {.callout-important .fragment title="The Problem 1/2"}
...
::: {.callout-important .fragment title="The Problem 2/2"}
...
We argue that AI – and in particular its **personalized content** - could influence climate attitudes and overcome some of the limitations of pure information provision.
...
- From a *practical perspective*, AI can:
    ...
    + **Cost-effective**: Reduce costs significantly (see [Appendix](#appendix) for cost analysis)
...
<div style="text-align: center;">
  <img src="figures/diagram.png" alt="AI diagram" style="width: 60%;">
</div>

See detailed **prompts** in the appendix [Appendix](#detailed-prompts)

## The Treatments {#treatments}

Participants are randomized into these conditions: 

1. **Control:** Standard information provision about climate change

2. **Non-Personalized AI - Climate Change:** LLM conversation about climate change not tailored to the respondent

3. **Personalized AI - Unrelated Political Topic:** Personalized AI-driven conversation about a political topic unrelated to climate change

4. **Personalized AI - Climate Change:** Personalized AI-driven conversation about climate change
...
- Personalized vs. non-personalized AI interactions is whether the AI is prompted to adapt its responses to the participant’s prior inputs (demographics, concerns, open-text answers)
:::
:::
...
- **Subjective climate beliefs:** Open-ended question about personal beliefs on climate change + LLM-generated 1-100 scale
...
<div style="width: 48%; background: white; border-radius: 8px; padding: 1rem; border: 2px solid #007f3b;">
  ...
  <div style="background: #f8f9fa; border-radius: 6px; padding: 0.8rem; border: 1px solid #ddd;">
    <div style="display: flex; align-items: center; margin-bottom: 0.5rem;">
      ...
      <div style="font-weight: bold; font-size: 0.8em;">Green Peace UK</div>
    </div>
...
<img src="figures/scaling_analysis.png" alt="Climate change image" style="width: 100%; height: auto; border-radius: 8px;">
</div>
...
## Prompts 1/4 {#detailed-prompts}

<div style="width: 90%; margin: 0 auto;">
<img src="figures/prompt1.png" alt="Climate change image" style="width: 100%; height: auto; border-radius: 8px;">
</div>
...
<div style="width: 90%; margin: 0 auto;">
<img src="figures/prompt2.png" alt="Climate change image" style="width: 100%; height: auto; border-radius: 8px;">
</div>

## Prompts 3/4

<div style="width: 90%; margin: 0 auto;">
<img src="figures/prompt3.png" alt="Climate change image" style="width: 100%; height: auto; border-radius: 8px;">
</div>

## Prompts 4/4

<div style="width: 90%; margin: 0 auto;">
<img src="figures/prompt4.png" alt="Climate change image" style="width: 100%; height: auto; border-radius: 8px;">
</div>

[Back to treatments](#treatments)
