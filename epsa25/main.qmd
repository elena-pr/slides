...
- From a *practical perspective*, AI can:
    + **Scale**: Online implementation + individual-level personalisation
...
- Conditions **3** and **4** serve as placebos for each other to isolate the effect of personalisation
...
- Climate Concern Personalised Measure:
...
- Climate Change Personalised Treatment
